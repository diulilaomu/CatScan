...
fun SettingsDrawer(
    ...
    ModalDrawerSheet(modifier = Modifier.width(300.dp)) {
        ...
        Text(
            text = "Wenhe x Rnzy 2025.11.1 CatScan MIT",
...
private fun MainSettingsPage(
    ...
    LaunchedEffect(
        ...
        channel2MinSolidityScore,
        channel2MinGradScore
    ) {
